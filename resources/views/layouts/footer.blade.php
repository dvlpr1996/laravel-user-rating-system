<footer class="flex flex-col items-center justify-center gap-5 rounded-lg bg-slate-800 py-8 px-4 font-medium text-gray-300 text-center">

	<div class="space-x-4">
			<a href="https://codepen.io/dvlpr1996" title="codepen">
					<i class="fab fa-codepen text-3xl"></i>
			</a>
